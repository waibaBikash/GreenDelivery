...
const Cart = () => {
  ...
  const { products, currency, cartItems, removeFromCart, getCartCount, updatedCartItem, navigate, getCartItem, getCartAmount} = useAppContext()
                      ...
                      <div className="flex items-center md:gap-6 gap-3">
                          ...
                          <div>
                              ...
                              <div className="font-normal text-gray-500/70">
                                  <p>
                                    Weight: <span>{product.weight || "N/A"}</span></p>
          ...
          <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
              ...
              <div className="mb-6">
                  ...
                  <div className="relative flex justify-between items-start mt-2">
                      <p className="text-gray-500">{selectedAddresses ? `${selectedAddresses.street}, ${selectedAddresses.city},${selectedAddresses.state},${selectedAddresses.country}` : "No address found"}</p>
